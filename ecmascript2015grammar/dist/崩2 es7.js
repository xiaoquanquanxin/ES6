...
(function () {
     ...
     */
    var CACHENAME = 'hsod2-2018.09.20v1';
    var urls = [
    /**
     * These files are important and useful for almost all pages.
     */
    '/', '/m/css/mdui.min.css', '/m/js/mdui.min.js', '/javascripts/vue.min.js', '/javascripts/axios.min.js',
    /**
     * Pages of the whole site.
     */
    '/cms', '/buglist', '/list/auto', '/worldbattle/20182', '/equip',
    /**
     * Inner world helper assets
     */
    '/m/js/innerWorld.vendors.js', '/m/js/innerWorld.js', '/m/css/innerWorld.css',
    /**
    ...
    var caching = false;
    var laterPrecache = new (function () {
    ...
    self.addEventListener('fetch', function (e) {
        ...
        if (isRequestRaceable(e.request.url)) {
            ...
            e.respondWith(caches.match(e.request).then(function (res) {
                if (res) {
                    var fetchRes = new Promise(async function (resolve) {
                    ...
                    var cacheRes = new Promise(function (resolve) {
                        setTimeout(function (_) {
                            return resolve(res);
                        }, 2000);
                    });
                    return Promise.race([fetchRes, cacheRes]);
                } else return fetch(e.request).then(function (res) {
                    var resp = res.clone();
        ...
        } else if (!isRequestCacheable(e.request.url)) return fetch(e.request);else e.respondWith(caches.match(e.request).then(function (res) {
            if (res) {
                /**
                 ...
                 */
                if (!isRequestStatic(e.request.url)) fetch(e.request).then(function (_res) {
                    if (!res || res.status !== 200) return res;
                    caches.open(CACHENAME).then(function (cache) {
    ...
    function cacheForUrls(cache, urls, i) {
         ...
         */
        setTimeout(function () {
            cache.add(urls[i]).catch(function () {
    ...
    setInterval(function (_) {
        ...
        if (laterPrecache.length) {
             ...
             */
            var _urls = [];
            for (var i = 0; i < laterPrecache.length; i++) {
    ...
    function isRequestCacheable(url) {
        ...
        try {
            for (var _iterator3 = excludes[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                var e = _step3.value;
    ...
    function isRequestStatic(url) {
        ...
        try {
            for (var _iterator4 = statics[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                var s = _step4.value;
    ...
    function isRequestRaceable(url) {
        ...
        try {
            for (var _iterator5 = races[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                var r = _step5.value;
...
function a(t, e, i) {
    ...
    var a = i("2b0e"),
        ...
        r = (i("7f7f"), i("ac4d"), i("8a81"), i("ac6a"), i("bc3a")),
        o = i.n(r),
        l = function l() {
        var t = this,
            e = t.$createElement,
        ...
        c = window.mdui,
        d = {
        props: { title: String }, mounted: function mounted() {
            c.mutation();
        }
    },
        m = d,
        p = (i("4f6d"), i("2877")),
        v = Object(p["a"])(m, l, u, !1, null, "05b807f1", null);
    ...
    var f = v.exports,
        ...
        b = window.mdui,
        y = {
        props: { drawer: Array }, mounted: function mounted() {
            b.mutation("#drawer");
        }
    },
        _ = y,
        w = Object(p["a"])(_, h, g, !1, null, null, null);
    w.options.__file = "IwDrawer.vue";
    var C = w.exports,
        x = window.mdui,
        S = x.JQ,
        $ = {
        name: "app", data: function data() {
            return {
            ...
            update: function update() {
                this.saveUsed();
            }, updateEquips: function updateEquips() {
                this.saveUsed();
            }, loadUsed: function loadUsed() {
                var t = JSON.parse(window.localStorage.getItem("used"));
                this.$store.commit("used", t || []);
            }, saveUsed: function saveUsed() {
                window.localStorage.setItem("used", JSON.stringify(this.used));
            }
        }, components: { IwHeader: f, IwDrawer: C }, mounted: function mounted() {
            var t = this;
        ...
        q = $,
        O = (i("034f"), Object(p["a"])(q, s, n, !1, null, null, null));
    ...
    var P = function P(t) {
        ...
        mutations: {
            ...
            }, addEquips: function addEquips(t, e) {
            ...
            }, removeEquips: function removeEquips(t, e) {
                var i = !0,
                    s = !1,
                    n = void 0;
                try {
            ...
            }, addUsed: function addUsed(t, e) {
                var i = t.used[e];
                !i || i.used >= i.max || (i.used += 1);
            }, minusUsed: function minusUsed(t, e) {
                var i = t.used[e];
                !i || i.used <= 0 || (i.used -= 1);
            }, clearUsed: function clearUsed(t) {
                for (var e in t.used) {
                    t.used[e].used = 0;
                }
            }
        ...
        getters: {
            used: function used(t) {
                var e = [];
                for (var i in window.log || (window.log = []), t.used) {
                    i && t.used[i] && e.push(t.used[i]), window.log.push([i, t.used[i], e.length]);
                }return window.log.push(e), e.filter(function (t) {
                    return t;
                });
            }, equips: function equips(t) {
                var e = [];
                for (var i in t.equips) {
                    e.push(t.equips[i]);
                }return e;
            }, raw: function raw(t) {
                var e = {};
                ...
                return e;
            }, ownEquips: function ownEquips(t) {
                var e = {};
                for (var i in t.used) {
                    var a = t.$minify[i];
        ...
        props: {
            ...
            idToString: function idToString(t) {
                t = t.toString();
                for (var e = "", i = 0; i < 3 - t.length; i++) {
                    e += "0";
                }return e + t;
        ...
        Q = B,
        U = (i("fe45"), Object(p["a"])(Q, J, L, !1, null, null, null));
    ...
    var M = U.exports,
        ...
        H = [],
        W = (i("c5f6"), {
        props: { value: String, id: [String, Number], editable: Boolean }, data: function data() {
            return { val: 0 };
        }, created: function created() {
            this.val = this.value;
        }, methods: {
        ...
        z = W,
        Y = (i("aff3"), Object(p["a"])(z, R, H, !1, null, "ebc157a8", null));
    ...
    var G = Y.exports,
        ...
        V = [],
        X = {
        props: { value: [Number, String], id: [String, Number], editable: Boolean }, data: function data() {
            return { val: 0 };
        }, created: function created() {
        ...
        Z = X,
        tt = (i("4a4f"), Object(p["a"])(Z, K, V, !1, null, "dcab18cc", null));
    ...
    var et = tt.exports,
        ...
        at = it,
        st = (i("7f3f"), Object(p["a"])(at, D, F, !1, null, "748733f4", null));
    ...
    var nt = st.exports,
        ...
        lt = {
        components: { IwStaticTable: nt }, data: function data() {
        ...
        ut = lt,
        ct = (i("e0fd"), Object(p["a"])(ut, j, A, !1, null, "3c2a9aba", null));
    ...
    var dt = ct.exports,
        ...
        data: function data() {
            return {
                ...
                sortFns: {
                    ...
                    }, usage: function usage(t, e) {
                        var i = t.usage[1] - t.usage[0],
                            a = e.usage[1] - e.usage[0];
                        return a - i;
                    }
                },
                sortOption: "",
        ...
        computed: {
            ...
            }, itemsInPage: function itemsInPage() {
                for (var t = this.currentPage * this.itemsPerPage, e = t + this.itemsPerPage, i = [], a = t; a < e; a++) {
                    this.sortedItems[a] && i.push(this.sortedItems[a]);
                }return i;
            }, pages: function pages() {
                var t = this.totalPage,
                    e = this.currentPage,
                    i = [];
                if (t <= 5) for (var a = 1; a <= t; a++) {
                    i.push(a);
                } else i = e < 2 ? [1, 2, 3, "...", t - 2, t - 1, t] : 4 == e ? [1, 2, 3, 4, 5, "...", t] : e == t - 3 ? [1, 2, "...", t - 3, t - 2, t - 1, t] : e > t - 3 ? [1, 2, "...", t - 2, t - 1, t] : [1, "...", e, e + 1, e + 2, "...", t];
                return i.push(">", ">|"), i.unshift("|<", "<"), i;
            }
        },
        methods: {
            paging: function paging(t) {
        ...
        watch: {
            totalPage: function totalPage(t) {
        ...
        gt = ht,
        bt = (i("a7ff"), Object(p["a"])(gt, vt, ft, !1, null, "07dc1136", null));
    ...
    var yt = bt.exports,
        ...
        Ct = i("8afe"),
        xt = {
        props: { all: Object, title: String, single: Boolean }, data: function data() {
            return {
                selected: {},
                currentPage: 0,
                searchInput: "",
            ...
            allEquips: function allEquips() {
                var t = [],
                    e = [];
                for (var i in this.all) {
                    e.push.apply(e, Object(Ct["a"])(this.all[i]));
                ...
                if (t <= 5) for (var a = 1; a <= t; a++) {
                    i.push(a);
                } else i = e < 2 ? [1, 2, 3, "...", t] : 3 == e ? [1, 2, 3, 4, "..."] : e == t - 3 ? ["...", t - 3, t - 2, t - 1, t] : e > t - 3 ? [1, "...", t - 2, t - 1, t] : ["...", e, e + 1, e + 2, "..."];
                return i.push(">", ">|"), i.unshift("|<", "<"), i;
            }
        }, methods: {
        ...
        St = xt,
        $t = (i("05c0"), Object(p["a"])(St, _t, wt, !1, null, "20cc7bf5", null));
    ...
    var qt = $t.exports,
        ...
        It = {
        props: { all: Object, title: String, raw: Object }, data: function data() {
            return {
                operations: {
            ...
            operate: function operate(t) {
                return this[t]();
            }, addAll: function addAll() {
                this.$emit("select", { type: "add", data: this.allId });
            }, addSome: function addSome() {
                ...
                var t = document.getElementById("raw-data"),
                    e = JSON.stringify(this.raw);
            ...
            }, readFromFile: function readFromFile() {
                var t = this.rawText || "";
        ...
        Et = It,
        Pt = (i("ecd1"), Object(p["a"])(Et, Ot, Tt, !1, null, "a06ebc6c", null));
    Pt.options.__file = "StoreSetting.vue";
    var kt = Pt.exports,
        Nt = window.mdui,
        jt = {
        props: { used: Array, minify: Object }, data: function data() {
            ...
            equips: function equips() {
                ...
                return t;
            }, allButOwn: function allButOwn() {
                var t = this,
                    e = {};
                for (var i in this.all) {
                    e[i] = this.all[i].filter(function (e) {
                        var i = !0,
                            a = !1,
                            s = void 0;
                        try {
                ...
                return t;
            }, itemsToSelect: function itemsToSelect() {
        ...
        }, components: { IwStore: yt, EquipSelector: qt, StoreSetting: kt }, beforeMount: function beforeMount() {
            Nt.JQ("#progress").show();
        }, mounted: function mounted() {
            this.all = this.minify, this.equipList = this.parseEquips(this.minify), this.loadFromLocal(), this.hideLoading();
        }, methods: {
            parseEquips: function parseEquips(t) {
                var e = [],
                    i = function i(_i) {
                    t[_i].forEach(function (t) {
                        return e.push({ equip: t, type: _i });
                    });
                };
                for (var a in t) {
                    i(a);
                }for (var s = [], n = 0; n < e.length; n++) {
                    var r = e[n].equip.split("$"),
                        o = {
                        weapon: [0, 2],
                        passive_skill: [0, 2],
                        costume: [0, 3],
                ...
                var t = this,
                    e = JSON.parse(window.localStorage.getItem("my-equips"));
            ...
            }, addToStore: function addToStore(t) {
                var e = this,
                    i = t.map(function (t) {
                    return e.elmap[e.formatId(t)];
                });
                this.$store.commit("addEquips", i), this.saveToLocal();
            }, removeFromStore: function removeFromStore(t) {
                var e = this,
                    i = t.map(function (t) {
                    return e.formatId(t);
                });
        ...
        At = jt,
        Dt = Object(p["a"])(At, mt, pt, !1, null, null, null);
    ...
    var Ft = Dt.exports,
        ...
        Wt = [],
        zt = {
        props: { value: Array, id: [String, Number], editable: Boolean }, data: function data() {
            return { val: {}, used: [] };
        }, created: function created() {
            if (this.val = this.value, this.val.length < 8) for (var t = this.val.length; t < 8; t++) {
                this.val.push("");
            } else this.val.length > 8 && this.val.splice(8);
        }, computed: {
            availableEquips: function availableEquips() {
                var t = [],
                    e = !0,
                    i = !1,
                    a = void 0;
            ...
            update: function update() {}, changeItem: function changeItem(t) {
                this.editable && this.$emit("click", [this.id, t]);
            }
        }
    },
        Yt = zt,
        Gt = (i("149a"), Object(p["a"])(Yt, Ht, Wt, !1, null, "67295418", null));
    ...
    var Kt = Gt.exports,
        ...
        te = Zt,
        ee = (i("251a"), Object(p["a"])(te, Vt, Xt, !1, null, "218d6ca5", null));
    ...
    var ie = ee.exports,
        ...
        computed: {
            usedMap: function usedMap() {
                ...
                return t;
            }, equipOptions: function equipOptions() {
                var t = this.$store.getters.ownEquips || {},
                    e = {};
        ...
        methods: {
            formatId: function formatId(t) {
            ...
            }, showSelect: function showSelect(t) {
                var e = this,
                    i = t[0].split("-"),
                    s = Object(I["a"])(i, 3),
                    n = s[0],
                ...
                var i = Object(I["a"])(this.editing, 3),
                    a = i[0],
                    s = i[1],
                    n = i[2],
                    r = this.body[a][s][n],
                ...
                for (this.body.splice(t, 1); t < this.body.length; t++) {
                    this.body[t][0] -= 1;
                }this.$emit("set");
            }
        }
        ...
        ne = se,
        re = (i("19eb"), Object(p["a"])(ne, Mt, Rt, !1, null, "0bbb1ea8", null));
    ...
    var oe = re.exports,
        ...
        methods: {
            operate: function operate(t) {
            ...
            }, saveAsExcel: function saveAsExcel() {
                this.showLoading(), this.dialog.close();
                var t = [],
                    e = ["层数", "模式", "模式", "计分倾向", "击杀", "连击", "被击", "时间", "积分", "备注"],
                    i = [{ wch: 5 }, { wch: 18 }, { wch: 18 }, { wch: 10 }, { wch: 5 }, { wch: 5 }, { wch: 5 }, { wch: 5 }, { wch: 6 }, { wch: 24 }];
                t.push(e);
                var a = !0,
                    s = !1,
                    n = void 0;
                ...
                var h = Ut.a.utils.book_new(),
                    g = Ut.a.utils.aoa_to_sheet(t);
                ...
                this.hideLoading();
            }, checkDumplicate: function checkDumplicate() {
            ...
            }, updateBody: function updateBody(t) {
                var e = this,
                    i = Object(I["a"])(t, 3),
                    s = i[0],
                    n = i[1],
            ...
            }, updateEquip: function updateEquip(t) {
                var e = this,
                    i = Object(I["a"])(t, 4),
                    s = i[0],
                    n = i[1],
            ...
            }, cloudImport: function cloudImport() {
                var t = this;
                ...
                var t = document.getElementById("raw-data"),
                    e = JSON.stringify(this.table.body);
    ...
    function ce() {
        var t = new Date(),
            ...
            i = [t.getFullYear(), t.getMonth() + 1, t.getDay()],
            a = i[0],
            s = i[1],
            n = i[2],
            r = [t.getHours(), t.getMinutes()],
            o = r[0],
            l = r[1];
    ...
    var de = ue,
        me = (i("a42d"), Object(p["a"])(de, Jt, Lt, !1, null, "85d62d80", null));
    ...
    var ve = [{ path: "/", component: dt }, { path: "/my-equips", component: Ft }, {
        ...
        fe = new N["a"]({
        routes: ve, scrollBehavior: function scrollBehavior() {
            return { x: 0, y: 0 };
        }
    });
    fe.beforeResolve(function (t, e, i) {
        ...
        router: fe, store: k, render: function render(t) {
            return t(T);
        }
    }).$mount("#app");
};
...
!function (t, e) {
        ...
        var g = [],
            ...
            if (l(n)) {
                ...
                if ("<" === (n = n.trim())[0] && ">" === n[n.length - 1]) {
                    var r = "div";
                    for (0 === n.indexOf("<li") && (r = "ul"), 0 === n.indexOf("<tr") && (r = "tbody"), 0 !== n.indexOf("<td") && 0 !== n.indexOf("<th") || (r = "tr"), 0 === n.indexOf("<tbody") && (r = "table"), 0 === n.indexOf("<option") && (r = "select"), (s = e.createElement(r)).innerHTML = n, o = 0; o < s.childNodes.length; o++) {
                ...
                if (n.nodeType || n === t || n === e) i.push(n);else if (n.length > 0 && n[0].nodeType) for (o = 0; o < n.length; o++) {
                    i.push(n[o]);
                }
            }
            return new C(i);
        ...
        return o(["", "All", "Until"], function (t, e) {
            ...
            k.fn.extend({
                ...
                on: function on(t, e, a, _s, r) {
                    ...
                    if (l(e) || u(_s) || !1 === _s || (_s = a, a = e, e = n), (u(a) || !1 === a) && (_s = a, a = n), !1 === _s && (_s = f), 1 === r) {
                        var d = _s;
                        _s = function s() {
            ...
            k.extend({
                ...
                ajax: function ajax(d) {
                    ...
                    return T.onload = function () {
                        E && clearTimeout(E);
                        var t,
                            e = T.status >= 200 && T.status < 300 || 0 === T.status;
                        if (e) {
    ...
    var s = function s(t) {
        ...
        if ("object" == (typeof t === 'undefined' ? 'undefined' : _typeof(t))) return t;
        var n = t.indexOf("{");
        try {
    ...
    return t.Collapse = function () {
        ...
        "function" == typeof i && (i = "", o = arguments[1], a = arguments[2]), void 0 === o && (o = function o() {}), void 0 === a && (a = {});
        var s = {
            confirmText: "ok",
            history: !0,
            modal: !1,
        ...
        "function" == typeof i && (i = "", o = arguments[1], a = arguments[2], s = arguments[3]), void 0 === o && (o = function o() {}), void 0 === a && (a = function a() {}), void 0 === s && (s = {});
        var r = {
            confirmText: "ok",
            cancelText: "cancel",
            history: !0,
